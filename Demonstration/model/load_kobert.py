...
class DialogKoBERT:
    def __init__(self):
        self.root_path= 'C:\\sqlite\\mysql\\code\\AI\\FINAL_project\\Capstone_2022-main\\Capstone_2022-main'
        # self.checkpoint_path =f"{self.root_path}/model"
        self.save_ckpt_path = f"{self.root_path}\\koelectra-wellnesee-text-classification.pth"
        #답변과 카테고리 불러오기
    ...
    def predict(self, sentence):
        category_path = "C:\\sqlite\\mysql\\code\\AI\\FINAL_project\\Capstone_2022-main\\Capstone_2022-main\\Demonstration\\data\\category.txt"
...
def load_wellness_answer():
  root_path = 'C:\\sqlite\\mysql\\code\\AI\\FINAL_project\\Capstone_2022-main\\Capstone_2022-main\\Demonstration'
